...
from utils.save_load import save_torch_model
from models.focal_loss import FocalLoss
from models.fraud_nn import FraudNN
from utils.preprocess import scale_all_features, split_features_labels
...
def train_focal_model(X_train, y_train, X_test, y_test, epochs=50, lr=1e-3, batch_size=512, return_scores=False):
    ...
    # Model
    model = FraudNN(input_dim=X_train_t.shape[1]).to(device)
    ...
    save_torch_model(model, "models/focal_nn.pt")
